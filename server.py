...
class PromptServer():
    ...
    def add_routes(self):
        ...
        from app.webapp.routes import register_webapp_routes
        register_webapp_routes(self.app)
        
        from app.webapp.manager import set_server_instance
        ...
        webapp_web_path = os.path.join(os.path.dirname(__file__), 'web', 'webapp')
        if os.path.exists(webapp_web_path):
            self.app.add_routes([
                web.static('/webapp', webapp_web_path)
            ])
